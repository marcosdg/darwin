 ...
 * involving a real-based (or any other) phenotipic representation needs to mapped
 * to an equivalent integer-based genotipic representation. This mapping can be 
 * achieved by means of a decoding function and choosing the right genetic
 * representation of individuals for the problem.
 *
 * */
#define GENE_BYTES sizeof(int)

struct genotype_encoding {
