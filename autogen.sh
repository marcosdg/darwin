...
## along with darwin.  If not, see <http://www.gnu.org/licenses/>.

### NOTE 1:
## This file was adapted from the autogen.sh in the GNU Emacs GitHub repo.
...
Building darwin from the repository requires the following specialized programs:
EOF
...
Please report any problems with this script to marcos.diez.garcia@gmail.com .
EOF
